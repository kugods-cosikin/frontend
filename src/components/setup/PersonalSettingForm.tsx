...
const settingOption = ['personal', 'host'];

function PersonalSettingForm() {
  const [options, setOptions] = useState(settingOption[0]);
  ...
  return (
    <div id="settingBox">
      ...
      <form id="content">
        ...
        <div id="textInputs">
          <div id="name">
            <div className="informs">
              First Name
              <input type="text" placeholder="Enter your first name (ex.Harry)" />
            </div>
            <div className="informs">
              Last Name
              <input type="text" placeholder="Enter your last name (ex.Porter)" />
            </div>
          </div>
        </div>
        ...
        <div className="informs">
          Username
          <input type="text" placeholder="Enter your usernmae" />
        </div>
